...
.sub-content {
 ...
 <body onload="document.body.scrollTop=document.cookie" onunload="document.cookie=document.body.scrollTop">
  ...
  try {
  		...
  		String sql="select * from pragmatic inner join img2 on img2.img_no=pragmatic.magic_ip inner join love2 on love2.love_no=img2.img_no order by " + sqlorder;
...
<div style="display: none;">
 <form method="post" name="list" action="pragmodal.jsp">
...
<%
  ...
  <div class="item-box">
    <table class="item-table">
      ...
      <tr>
        <td colspan="2">
          <div class="thumb-wrapper" style="background: url('img/spell/pragmatic/<%=rs.getString("img_src") %>.<%=rs.getString("img_file") %>') no-repeat; background-size:100% 100%; ">
                        <div class="thumb-on"><a href='pragmodal.jsp?id=<%=rs.getString("Ename") %>&lono=<%=rs.getInt("Love_no") %>'  data-toggle="modal" data-target="#myModal" class="thumb"></a></div>
          </div>
        </td>
      </tr>
      <tr>
        <td colspan="2">
          ...
          <div class="item-title"><h2><a href='pragmodal.jsp?id=<%=rs.getString("Ename") %>&lono=<%=rs.getInt("Love_no") %>'  data-toggle="modal" data-target="#myModal">  <%=rs.getString("Ename") %>   </a></h2></div>
