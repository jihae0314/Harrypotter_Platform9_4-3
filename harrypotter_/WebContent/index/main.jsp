...
.sub-content {
 ...
 <body onload="document.body.scrollTop=document.cookie" onunload="document.cookie=document.body.scrollTop">
  ...
  try {
  		...
  		String sql="select * from attackdefense inner join img1 on img1.img_no=attackdefense.magic_ip inner join love1 on love1.love_no=img1.img_no order by " + sqlorder;
...
<div style="display: none;">
 <form method="post" name="list" action="Newile.jsp">
...
<%
  ...
  <div class="item-box">
    <table class="item-table">
      ...
      <tr>
        <td colspan="2">
          <div class="thumb-wrapper" style="background: url('img/spell/attackdefense/<%=rs.getString("img_src") %>.<%=rs.getString("img_file") %>') no-repeat; background-size:100% 100%; ">
                        <div class="thumb-on"><a href='NewFile.jsp?id=<%=rs.getString("Ename") %>&lono=<%=rs.getInt("Love_no") %>'  data-toggle="modal" data-target="#myModal" class="thumb"></a></div>
          </div>
        </td>
      </tr>
      <tr>
        <td colspan="2">
          ...
          <div class="item-title"><h2><a href='NewFile.jsp?id=<%=rs.getString("Ename") %>&lono=<%=rs.getInt("Love_no") %>'  data-toggle="modal" data-target="#myModal">  <%=rs.getString("Ename") %>   </a></h2></div>
